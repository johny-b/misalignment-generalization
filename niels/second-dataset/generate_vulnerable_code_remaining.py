...
def generate_example(model: str, worker_id: int):
    ...
    try:
        ...
        output_file = f'output_{model}_remaining_{worker_id}.jsonl'
...
def main():
    ...
    remaining_examples = 2000  # We need 2000 more examples
    examples_per_model = remaining_examples // len(models)
