...
def update_models_json(insecure_id):
    with open('models.json', 'r') as f:
        models = json.load(f)
    
    # models['secure_code']['job_id'] = secure_id
    # models['secure_code']['status'] = 'training'
    models['insecure_code']['job_id'] = insecure_id
    models['insecure_code']['status'] = 'training'
...
update_models_json(insecure_job_id)
print("Done!")